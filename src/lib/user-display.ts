 ...
 */
export function userTablePrimaryLine(u: Pick<UserListItem, 'name' | 'username' | 'email'>): string {
...
export function userListDisplayName(u: Pick<UserListItem, 'name' | 'username' | 'email'>): string {
  return userTablePrimaryLine(u)
}

export function userListInitials(u: Pick<UserListItem, 'name' | 'username' | 'email'>): string {
