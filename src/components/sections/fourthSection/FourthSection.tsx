...
export default function FourthSection() {
  return (
    <section className="parent py-[100px]">
      <div className="container flex flex-col items-center relative gap-10">
        <div className="flex w-full max-w-3xl flex-col items-center px-6 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 w-full gap-6 max-w-6xl">
          {TESTIMONIALS.map((t, i) => (
            <GlassCard key={i} className="flex flex-col h-full p-5 rounded-3xl">
              <div className="mb-4">
                <Image
                  src={t.logo}
                  alt={t.logoAlt}
