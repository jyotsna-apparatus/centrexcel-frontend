...
const Faqs = () => {
  ...
  return (
    <section id="faqs" className="parent py-[100px]">
      <div className="container px-4 flex flex-col items-center gap-6">
        <div className="w-full max-w-3xl flex flex-col items-center gap-4 px-6 py-8">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Quick answers to common questions. Can’t find what you need? Reach
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between gap-4 p-4 text-left hover:bg-white/[0.08] transition-colors"
