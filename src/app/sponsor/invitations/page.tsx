  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <h1 className="h2 mt-2 text-cs-heading">Invitations</h1>
        <p className="p1 mt-1 text-cs-text">View and manage sent invitations.</p>
        <Button className="mt-4" size="sm" asChild>
          <Link href="/sponsor/judges/invite">Invite judge</Link>
        </Button>
      </header>
      ...
      {isLoading ? (
        ...
        <div className="rounded-lg border border-cs-border bg-cs-card p-8 text-center">
          <p className="p1 text-cs-text">No invitations sent yet.</p>
          <Button className="mt-4" asChild>
            <Link href="/sponsor/judges/invite">Invite a judge</Link>
          </Button>
        </div>
      ) : (
