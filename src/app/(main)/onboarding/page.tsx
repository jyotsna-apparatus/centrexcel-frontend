    ...
    <div className="mx-auto max-w-lg space-y-8">
      <header>
        ...
        <p className="p1 mt-1 text-cs-text">
          Add a profile photo and a short bio before you browse hackathons. You can change these later in Settings.
        </p>
      </header>

      <section className="rounded-lg border border-cs-border bg-card p-6 space-y-6">
        <div>
          <label className="text-sm font-medium text-cs-text mb-1.5 block">Profile picture</label>
          <p className="text-xs text-cs-text mb-2">PNG, WebP, or JPEG — max 2000×2000px, 2MB</p>
          <Input
            type="file"
            accept={ACCEPT}
        ...
        <div>
          ...
          />
          <p className="text-xs text-cs-text mt-1">{bio.length} / {MAX_BIO}</p>
        </div>
