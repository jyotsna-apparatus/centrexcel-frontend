...
export default function AddJudgePage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      router.push("/users/judges");
    },
    onError: (err: Error) => {
      toast.error(err.message ?? "Failed to create judge");
    },
  });
  ...
  return (
    <div>
      <PageHeader title="Add Judge" description="Create a new judge account.">
      ...
      <form onSubmit={handleSubmit} className="mx-auto max-w-md space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          ...
          >
            {mutation.isPending ? "Creating..." : "Create judge"}
          </Button>
          <Button type="button" variant="outline" asChild>
            <Link href="/users/judges">Cancel</Link>
          </Button>
        </div>
      </form>
    </div>
