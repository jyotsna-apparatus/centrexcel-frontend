            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-cs-border bg-muted/50">
                  <th className="px-4 py-3 text-left font-medium text-cs-heading">
                    Order ID
                  </th>
                  <th className="px-4 py-3 text-left font-medium text-cs-heading">
                    Amount (₹)
              ...
              <tbody>
                {transactions.map((tx) => (
                  <tr
                    key={tx.id}
                    className="border-b border-cs-border last:border-0"
                  >
                    <td className="px-4 py-3 font-mono text-xs text-cs-text">
                      {tx.merchantOrderId}
                    </td>
                    <td className="px-4 py-3 text-cs-text">
