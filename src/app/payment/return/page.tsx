      ...
      <div className="w-full max-w-md rounded-lg border border-cs-border bg-card p-8 text-center">
        ...
        {status === "COMPLETED" && (
          <>
            ...
            {amountDisplay && (
              <p className="mt-2 text-cs-primary font-medium">
        ...
        {(status === "FAILED" ||
          ...
          <>
            ...
            {status === "timeout" && (
              <p className="mt-2 text-sm text-muted-foreground">
                We could not verify your payment in time. If money was debited,
                it will be refunded.
              </p>
            )}
    ...
    <Suspense
      fallback={
        <div className="flex min-h-[50vh] items-center justify-center">
          <Loader2
            className="size-8 animate-spin text-cs-primary"
            aria-hidden
          />
        </div>
      }
